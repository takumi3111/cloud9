    ...
    @include('common.errors')         
        <form action="{{ url('tasks/update') }}" method="POST">             
            ...
            <div class="form-group">                 
                ...
                <input type="date" id="deadline" name="deadline" class="formcontrol" value="{{$task->deadline}}">             
            </div>             
        
            <!-- comment -->             
            <div class="form-group">                 
                <label for="comment">Comment</label> 
                <input type="text" id="comment" name="comment" class="formcontrol" value="{{$task->comment}}">             
            </div>
